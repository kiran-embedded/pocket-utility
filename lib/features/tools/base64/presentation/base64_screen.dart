...
class _Base64ScreenState extends State<Base64Screen> {
  ...
  void _convert() {
    ...
    try {
      ...
      _result = 'Invalid input for base64 decoding';
    }
    setState(() {});
  }

  void _copyResult() {
    if (_result.isNotEmpty && !_result.startsWith('Invalid')) {
        ...
        child: Column(
          ...
          children: [
            SegmentedButton<bool>(
              segments: const [
                ButtonSegment<bool>(value: true, label: Text('Encode')),
                ButtonSegment<bool>(value: false, label: Text('Decode')),
              ],
              selected: {_isEncode},
            ...
            TextField(
              ...
              decoration: InputDecoration(
                labelText: _isEncode ? 'Text to Encode' : 'Base64 to Decode',
